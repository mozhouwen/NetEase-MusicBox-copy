...
class Ui:
    ...
    def build_playinfo(self,song_name,artist,album_name):
        ...
        self.screen.move(1,9,'正在播放',curses.color_pair(3))
        self.screen.move(1,19,song_name+'  -  '+artist + ' < '+album_name+'>',curses.color_pair(2))
        self.screen.refresh()
    ...
    def build_menu(self,menus,menu_index,build):
        ...
        self.screen.move(4,19,menus['title'],curses.color_pair(1))
    ...
    def build_search(self,stype):
        ...
        if stype == 5:
            ...
            build = 'artists'
                ...
                data = api.search(artist_name,stype=1)
        ...
        def get_param(self,prompy_string):
            self.screen.clear()
