...
class Api:
    def __init__(self):
        ...
        def search(self,s,stype=1):
            ...
            return self.httpRequset('POST',action,self.data)
        ...
        def artists(self,artist_id):
            ...
            return self.httpRequset('GET',action)
        ...
        def song_detail(self,data,dig_type):
            if dig_type == 'songs':
                temp =[]
